        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <p className="text-xl text-base-content/70 leading-relaxed max-w-xl">
              A plataforma definitiva para entrevistas de codificação
              colaborativa e pares programação. Conecte-se pessoalmente,
              codifique em tempo real e vença as entrevistas técnicas.
            </p>
